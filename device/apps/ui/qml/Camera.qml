...
Rectangle {
    ...
    Rectangle {
        ...
        Column {
            ...
            // Retry button - custom rectangle to avoid native style issues
            Rectangle {
                anchors.horizontalCenter: parent.horizontalCenter
                width: 100
                height: 40
                color: retryButtonMouse.pressed ? App.Theme.primaryDark : App.Theme.primary
                radius: 4
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            // Back button (custom rectangle to avoid native style issues)
            Rectangle {
                width: 70
                height: 36
            ...
            // Camera switch button (front/back) - custom rectangle
            Rectangle {
                width: 80
                height: 36
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                height: 80
                radius: 40
                color: isCapturing ? App.Theme.disabled : "white"
    ...
    Rectangle {
        ...
        width: toastText.implicitWidth + App.Theme.spacingLarge
        height: 40
        radius: 20
